...
export async function run(provider: NetworkProvider) {
    ...
    assetBuilder.storeInt(4n, 64).endCell(); // код олперации, в случае jetton это 4
    assetBuilder.storeAddress(Address.parse('0QAwvRCtBbgp8QQXTPM73Vk0PMX66hqKTalrnfWxRfxTP4zc'))
    assetBuilder.storeStringTail('9d4bff8fa95b4b588c0658fc0b2a2b09')
    .endCell();
